...
async def _(event):
    ...
    packname = f"Chitra's Masterpiece"
    packshortname = f"chittustickers"  # format: Uni_Borg_userid
    ...
    if is_a_s:
        ...
        packname = f"Chitra's Animated Masterpiece"
        packshortname = f"chitraanimated"  # format: Uni_Borg_userid
    ...
    await event.edit(f"chura lia! Your pack can be found [here](t.me/addstickers/{packshortname})")
